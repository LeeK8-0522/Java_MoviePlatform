...
public class PersonalizedScorePrediction extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					PersonalizedScorePrediction frame = new PersonalizedScorePrediction();
	 ...
	 * Create the frame.
	 */
	public PersonalizedScorePrediction() {
		setResizable(false);
